...
public class registrarUsuario {
    ...
    public static final Target CONFIRMAR_CONTRASEÑA = Target.the("confirmar contraseña").locatedBy("//input[@id='confirmPassword']");
    public static final Target CHECK_TERMINOS = Target.the("check terminos").locatedBy("//*[@class='checkmark signup-consent__checkbox error']']");
    public static final Target CHECK_PRIVACIDAD = Target.the("check privacidad").locatedBy("//*[@class='checkmark signup-consent__checkbox error']");
